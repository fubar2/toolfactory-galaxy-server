...
def _parser():
    ...
    parser.add_argument("-w", "--wfpaths", help='workflow(s) to install', default=[])
    # default=["$GALAXY_ROOT/workflows/TF_demo_make_tools.ga", "$GALAXY_ROOT/workflows/TF_demo_make_test_tools_May_21.ga"])
    return parser
